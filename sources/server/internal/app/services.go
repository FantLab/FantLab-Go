...
func MakeServices(mysqlDB sqlr.DB, redisClient redisclient.Client, memcacheClient memcacheclient.Client, cryptoCoder *edsign.Coder, minioClient *minio.Client, minioBucket string) *Services {
	return &Services{
