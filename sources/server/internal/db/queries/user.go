...
const (
	...
	UserInfo           = "SELECT u.user_class, u.login, u.sex, g.access_to_forums FROM " + UserGroupsTable + " g JOIN " + UsersTable + " u ON u.user_group_id = g.user_group_id WHERE u.user_id = ? LIMIT 1"
