...
type Response_ResponseRatingResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Response_ResponseRatingResponse) Reset() {
	*x = Response_ResponseRatingResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *Response_ResponseRatingResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Response_ResponseRatingResponse) ProtoMessage() {}

func (x *Response_ResponseRatingResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_response_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Response_ResponseRatingResponse.ProtoReflect.Descriptor instead.
func (*Response_ResponseRatingResponse) Descriptor() ([]byte, []int) {
	return file_proto_response_proto_rawDescGZIP(), []int{0, 0}
}

func (x *Response_ResponseRatingResponse) GetRating() int64 {
	if x != nil {
		return x.Rating
	}
	return 0
...
var file_proto_response_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x3c, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x1a, 0x30, 0x0a, 0x16, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x61,
	0x74, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06,
	0x72, 0x61, 0x74, 0x69, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x72, 0x61,
	0x74, 0x69, 0x6e, 0x67, 0x42, 0x0c, 0x5a, 0x0a, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f,
...
var file_proto_response_proto_goTypes = []interface{}{
	...
	(*Response_ResponseRatingResponse)(nil), // 1: Response.ResponseRatingResponse
}
...
func file_proto_response_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_response_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Response_ResponseRatingResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
