...
var file_proto_auth_proto_rawDesc = []byte{
	...
	0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xac, 0x03, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68,
	0x1a, 0xbf, 0x02, 0x0a, 0x06, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x73, 0x12, 0x19, 0x0a, 0x08, 0x74,
	...
	0x04, 0x75, 0x73, 0x65, 0x72, 0x1a, 0xba, 0x01, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e,
	...
	0x64, 0x73, 0x1a, 0x62, 0x0a, 0x0c, 0x41, 0x75, 0x74, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
...
var file_proto_auth_proto_goTypes = []interface{}{
	(*Auth)(nil),                 // 0: Auth
	(*Auth_Claims)(nil),          // 1: Auth.Claims
	(*Auth_AuthResponse)(nil),    // 2: Auth.AuthResponse
	(*Auth_Claims_UserInfo)(nil), // 3: Auth.Claims.UserInfo
	(*timestamp.Timestamp)(nil),  // 4: google.protobuf.Timestamp
	(Common_Gender)(0),           // 5: Common.Gender
	(Common_UserClass)(0),        // 6: Common.UserClass
}
var file_proto_auth_proto_depIdxs = []int32{
	4, // 0: Auth.Claims.issued:type_name -> google.protobuf.Timestamp
	3, // 1: Auth.Claims.user:type_name -> Auth.Claims.UserInfo
	5, // 2: Auth.Claims.UserInfo.gender:type_name -> Common.Gender
	6, // 3: Auth.Claims.UserInfo.class:type_name -> Common.UserClass
