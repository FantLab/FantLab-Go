...
func Routes(config *shared.AppConfig, services *shared.Services, urlParamGetter endpoints.URLParamGetter) *Group {
	api := endpoints.MakeAPI(config, services, urlParamGetter)
